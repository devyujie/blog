...
- **AI 摘要：**
    - 接入[智谱](https://docs.bigmodel.cn/cn/guide/models/text/glm-4.7)的轻量高速小模型 `glm-4.7-flashx`，每篇文章自动生成 AI 摘要，方便读者快速了解文章核心内容。利用 AI 能力提取关键信息，让浏览更高效。
- **交互体验升级：**
